...
<head>
    ...
    <meta name="keywords"
        content="wrappixel, admin dashboard, html css dashboard, web dashboard, bootstrap 4 admin, bootstrap 4, css3 dashboard, bootstrap 4 dashboard, severny assets_admin bootstrap 4 dashboard, frontend, responsive bootstrap 4 assets_admin template, pixel  design, pixel  dashboard bootstrap 4 dashboard template">
        ...
        <nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header"> <a class="navbar-toggle hidden-sm hidden-md hidden-lg "
                ...
                <div class="top-left-part"><a class="logo" href="index.html"><b><img
                            ...
                            class="hidden-xs"><img src="{{asset('assets_admin/plugins/images/pixelassets_admin-text.png')}}" alt="home" /></span></a>
                </div>
                ...
                <ul class="nav navbar-top-links navbar-right pull-right">
                    <li>
                        <a class="profile-pic" href="#">  <i width="36" class="fa fa fa-user img-circle mr-1"></i><b class="hidden-xs">{{Auth::user()->name}}</b> </a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-header -->
        ...
        <div class="navbar-default sidebar" role="navigation">
            <div class="sidebar-nav navbar-collapse slimscrollsidebar">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="{{route("user_add")}}" class="waves-effect"><i class="fa fa-table fa-fw"
                                aria-hidden="true"></i><span class="hide-menu">Ajouter membre</span></a>
                    </li>

            ...
            <div class="sidebar-nav navbar-collapse slimscrollsidebar">
                <ul class="nav" id="side-menu">
                    <li style="padding: 10px 0 0;">
                        <a href="{{route('index')}}" class="waves-effect"><i class="fa fa-clock-o fa-fw"
                                aria-hidden="true"></i><span class="hide-menu">Accueil</span></a>
                    </li>
                    <li>
                        <a href="{{route('guest_profile')}}" class="waves-effect"><i class="fa fa-user fa-fw"
